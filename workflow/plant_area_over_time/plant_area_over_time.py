...
axes[0,1].set_title("Outlier Diff Spikes Removals (Up to n=5)")
axes[1,0].plot(filtered_df['hours_from_start'], filtered_df['rolling_mean'])
axes[1,0].set_title("Outlier Spike Removal + Rolling Mean")
axes[1,1].plot(filtered_df['hours_from_start'], filtered_df['smoothed'])
axes[1,1].set_title("Outlier Spike Removal + Smoothed")
